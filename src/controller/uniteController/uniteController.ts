...
export class UniteController {
    ...
    public getAllUnites = async (req: Request, res: Response, next: NextFunction) => {
        try {
    ...
    public getUniteById = async (req: Request, res: Response, next: NextFunction) => {
        try {
    ...
    public createUnite = async (req: Request, res: Response, next: NextFunction) => {
        try {
    ...
    public updateUnite = async (req: Request, res: Response, next: NextFunction) => {
        try {
            const unite = await this.uniteServices.updateUnite(req.params.id, req.body);
            res.status(200).json(unite);
        } catch (error) {
            next(error);
        }
    ...
    public deleteUnite = async (req: Request, res: Response, next: NextFunction) => {
        try {
